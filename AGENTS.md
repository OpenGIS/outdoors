...
Likewise, never link to source code by line number (e.g. `scripts/build.mjs#L2555-L2607`) — line anchors go out of sync the moment the file changes. Reference the function, constant, or section by name instead, e.g. `` `fetchLiberty()` in [`scripts/build.mjs`](scripts/build.mjs) ``.
