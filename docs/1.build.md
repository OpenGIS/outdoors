...
The contour service is separate: a fixed tile URL constant ([`CONTOUR_PBF_TILE_URL`](../scripts/build.mjs)) pointing at the hosted ogis.app contour service — the same host as the overlays (details in [Tile Server & Hosted Overlays](7.server.md)). See [Contours](5.contours.md) for the style-side implementation.
...
- [Style structure](2.style.md) — layer-by-layer reference, toggle-by-toggle
- [Low-zoom paths overlay](3.paths.md)
- [Outdoor POIs (catalogue-driven)](4.pois.md) — the catalogue-driven concept and implementation
- [Contours](5.contours.md)
- [Tile Server & Hosted Overlays](7.server.md) — the hosted tile services and how they are produced
