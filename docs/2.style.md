...
> **Known Issues**
>
> - **Too loud.** The map is showing too much (especially POIs), making it crowded. Paths are obnoxious. The focus was on sourcing and displaying the data "loud and proud" — it isn't subtle.
> - **z13–14 handoff.** Inconsistent styling: some geometries vanish/reappear and the stacking order is wrong (e.g. paths shown above bridges but actually going under them).
