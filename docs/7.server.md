...
- [The Style Build](1.build.md) — the tile endpoints and overlay toggles
- [Low-zoom paths overlay — style side](3.paths.md)
- [Outdoor POIs (catalogue-driven)](4.pois.md)
- [Contours — style side](5.contours.md)
