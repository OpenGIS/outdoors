...
3. [Low-zoom paths overlay](paths.md) - Live path tile source at tiles.ogis.app/paths (z9–13), generated by the Planetiler profile in docs/examples/FootpathOverlay.java; the style hands off to the base path layer at z14
